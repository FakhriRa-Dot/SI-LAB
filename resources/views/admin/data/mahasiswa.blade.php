...
@section('content')
    <div class="container mt-3" style="display: flex; flex-direction: column;">
        ...
        <div style="margin-bottom: 10px; display: flex; justify-content: flex-start;">
            <button class="btn btn-dark shadow" type="button" data-bs-toggle="collapse" data-bs-target="#formTambahMahasiswa"
                aria-expanded="false" aria-controls="formTambahMahasiswa">
                Tambah
            </button>
        </div>
                ...
                <tbody>
                    @foreach ($mahasiswa as $index => $mhs)
                        <tr>
                            ...
                            <td>
                                <!-- Edit Button -->
                                <a href="{{ route('data.mahasiswas.edit', $mhs->npm) }}"
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
            ...
            <div>
                <p class="text-muted mb-0">
                    Showing {{ $mahasiswa->firstItem() }} to {{ $mahasiswa->lastItem() }} of {{ $mahasiswa->total() }} results
                </p>
            </div>
            <!-- Right: Pagination -->
            <div>
