...
<div class="container mt-3" style="display: flex; flex-direction: column;">
    ...
    <div style="margin-bottom: 10px; display: flex; justify-content: flex-start;">
        <button class="btn btn-dark shadow" type="button" data-bs-toggle="collapse" data-bs-target="#formTambahMahasiswa" aria-expanded="false" aria-controls="formTambahMahasiswa">
            Tambah
        </button>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('data.mahasiswas.destroy', $mhs->npm) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm shadow" onclick="return confirm('Apakah Anda yakin ingin menghapus mahasiswa ini?')">
